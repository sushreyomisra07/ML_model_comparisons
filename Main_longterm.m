...
Y_train_rc(Y_train_rc~=2) = 0;
Y_train_rc(Y_train_rc==2) = 1;

Y_train_masonry(Y_train_masonry~=2) = 0;
Y_train_masonry(Y_train_masonry==2) = 1;

Y_test_rc(Y_test_rc~=2) = 0;
Y_test_rc(Y_test_rc==2) = 1;

Y_test_masonry(Y_test_masonry~=2) = 0;
Y_test_masonry(Y_test_masonry==2) = 1;
